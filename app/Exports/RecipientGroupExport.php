...
class RecipientGroupExport implements FromQuery, WithHeadings, WithMapping
{
    use Exportable;
    ...
    {
        return (new RecipientGroupController)->filter(RecipientGroup::class, RecipientGroup::query(), $this->request);
    }
