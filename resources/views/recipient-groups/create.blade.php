...
@section('dashboard-content')
    ...
    <h2 class="mb-5 text-left">{{ __('Create email trigger') }}</h2>

    @include('components.error-message')

    <form action="{{ route('recipient-groups.store') }}" method="POST" class="flex flex-col">
        @csrf
    
        @include('recipient-groups.form')
