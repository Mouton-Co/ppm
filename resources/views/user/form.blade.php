...
<select {{ auth()->user()->id == $user->id ? 'disabled' : '' }}
    class="w-full {{ !empty($errors->get('role')) ? 'field-error' : 'field-dark' }} mb-5" name="role"
    id="role">
...
class="{{ !empty($errors->get('password')) ? 'field-error' : 'field-dark' }} mb-5">
...
class="{{ !empty($errors->get('confirm_password')) ? 'field-error' : 'field-dark' }} mb-5">
