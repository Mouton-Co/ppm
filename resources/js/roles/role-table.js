export function roleTable() {
     ...
     */
    $("input[id^='create-'], input[id^='read-'], input[id^='update-'], input[id^='delete-']").on("click", function() {
    ...
    $("input[id^='create-'], input[id^='read-'], input[id^='update-'], input[id^='delete-']").on("click", function() {
        let role = $(this).attr("id").split("-")[1];
        if ($("#create-" + role).prop("checked") && $("#read-" + role).prop("checked") && $("#update-" + role).prop("checked") && $("#delete-" + role).prop("checked")) {
